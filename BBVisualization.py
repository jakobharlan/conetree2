...
class BoundingBoxVisualization(avango.script.Script):
  ...
  def my_constructor(self, NODE, SCENEGRAPH, MATERIAL):
    ...
    self.sf_node_mat.connect_from(NODE.WorldTransform)
  ...
  def calc_bb(self):
    ...
    self.bb = self.NODE.BoundingBox.value
  ...
  def update_bb_scale(self):
    ...
    if self.bb != None:
      ...
      _world_mat = self.NODE.WorldTransform.value
